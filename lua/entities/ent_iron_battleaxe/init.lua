...
function ENT:Initialize()
	...
	self:SetModel( "models/morrowind/iron/battleaxe/w_battleaxe.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("morrowind_iron_battleaxe") == NULL then
			activator:Give("morrowind_iron_battleaxe")
		else
