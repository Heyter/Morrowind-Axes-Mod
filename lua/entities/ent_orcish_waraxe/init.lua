...
function ENT:Initialize()
	...
	self:SetModel( "models/morrowind/orcish/waraxe/w_orcishwaraxe.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("morrowind_orcish_waraxe") == NULL then
			activator:Give("morrowind_orcish_waraxe")
		else
