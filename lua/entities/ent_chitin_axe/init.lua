...
function ENT:Initialize()
	...
	self:SetModel( "models/morrowind/chitin/axe/w_chitinaxe.mdl") -- Model Difference
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("morrowind_chitin_axe") == NULL then -- Weapon name Difference
			activator:Give("morrowind_chitin_axe")
		else
