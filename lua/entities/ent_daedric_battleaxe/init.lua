...
function ENT:Initialize()
	...
	self:SetModel( "models/morrowind/daedric/battleaxe/w_daedricbattleaxe.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("morrowind_daedric_battleaxe") == NULL then
			activator:Give("morrowind_daedric_battleaxe")
		else
