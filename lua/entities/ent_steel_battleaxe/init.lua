...
function ENT:Initialize()
	...
	self:SetModel( "models/morrowind/steel/battleaxe/w_steelbattleaxe.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("morrowind_steel_battleaxe") == NULL then
			activator:Give("morrowind_steel_battleaxe")
		else
