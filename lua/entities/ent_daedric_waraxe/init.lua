...
function ENT:Initialize()
	...
	self:SetModel( "models/morrowind/daedric/waraxe/w_daedricwaraxe.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) then
		if activator:GetWeapon("morrowind_daedric_waraxe") == NULL then
			activator:Give("morrowind_daedric_waraxe")
		else
